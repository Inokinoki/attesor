/* ============================================================================
 * Rosetta SIMD Helper Module - Implementation
 * ============================================================================
 *
 ...
 *
 * This is a software emulation of the ARM64 NEON UMINV instruction,
 * which finds the minimum byte value across a 128-bit vector.
 *
